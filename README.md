...
- [ ] Cross-check the declared sport against GPS: a stationary sport that stays inside a few metres is confirmed,
      one that travels at road speed was mislabelled, and that same test tells a genuine erg session apart from a
      workout somebody forgot to stop
